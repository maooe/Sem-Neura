...
import { Settings, Database, Shield, CheckCircle2, Copy, ExternalLink, HelpCircle, Send, AlertCircle, BrainCircuit, ArrowBigDownDash, RefreshCcw, XCircle, LayoutDashboard, ArrowRight } from 'lucide-react';
...
function doPost(e) {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-6 pb-32">
      <header className="flex items-center gap-6 mb-12">
        <div className="p-5 bg-blue-600 text-white rounded-[2rem] shadow-2xl shadow-blue-200">
          <Settings size={40} />
        </div>
        <div>
          <h2 className="text-4xl font-black text-slate-900 tracking-tight uppercase">Configurações</h2>
          <p className="text-slate-500 font-bold text-lg">Personalize sua experiência sem neura</p>
        </div>
      </header>

      {/* PAINEL DE CONEXÃO */}
      <section className="bg-blue-600 rounded-[3rem] p-10 shadow-2xl shadow-blue-200 text-white relative overflow-hidden border-4 border-white">
        <div className="relative z-10">
          ...
          <div className="space-y-8 bg-white/10 backdrop-blur-xl p-8 rounded-[2rem] border border-white/20">
